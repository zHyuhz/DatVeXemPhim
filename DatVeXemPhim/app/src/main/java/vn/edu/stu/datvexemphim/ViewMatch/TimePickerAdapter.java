...
import vn.edu.stu.datvexemphim.CustomEvent.ITimePicker;
...
public class TimePickerAdapter extends RecyclerView.Adapter<TimePickerAdapter.TimeViewHolder> {
    ...
    @NonNull
    @Override
    public TimePickerAdapter.TimeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_gio, parent, false);
        return new TimePickerAdapter.TimeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TimePickerAdapter.TimeViewHolder holder, int position) {
